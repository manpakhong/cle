<?php
	...
	class ResourceTypeFilter extends ResourceType
	{
		private $orderByList;
		...
		public function getWhereClause()
		{
			...
			foreach ($arr as $key => $value) {
			    ...
			    if (!is_null($value))
			    {
			    	...
			    	$returnWhereClause = $returnWhereClause . ResourceType::getDbFieldName($key) . "='" . $value . "'";
			    }
			}
			//echo 'where clause: ' . $returnWhereClause;
